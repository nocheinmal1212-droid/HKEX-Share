...
def check_manifest(manifest):
    ...
    assert manifest['version'] == 'direct-contributors-2026-09-17-v1'
    ...
    for entry in manifest['requests']:
        ...
        assert set(json.loads(body['messages'][1]['content'])) == {'operation', 'container_id', 'target_id', 'candidate_ids', 'evidence', 'limitations'}

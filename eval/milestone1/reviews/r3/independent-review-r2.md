Navigation-adjusted copy; [original bytes](inputs/independent-review-r2.original.md).
...
Reviewed [packet r2](original-r2/index.html), [guide](original-r2/review-guide.md),
[claim-by-claim verification](original-r2/audit-verification.md) and the supplied portable ZIP.
...
The [guide, line 29](original-r2/review-guide.md), the HTML banner, case guidance and
[audit-verification.md, line 19](original-r2/audit-verification.md) say that the source uses `採取` while
...
[inspection-result.json](source-inspection/inspection-result.json).

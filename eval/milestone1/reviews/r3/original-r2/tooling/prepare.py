...
def prepare(runs, output):
    ...
    files['independent-review.md'] = ('Navigation-adjusted copy; [original bytes](inputs/independent-review.original.md).\n\n'
    ...
    packet = {'schema_version': '2.0.0', 'mode': 'fixture', 'review_status': 'pending',
              ...
              'guidance': guidance, 'publication_status': 'UNGATED', 'headline': None,
    ...
    html += '<p class="banner">Percentage fidelity caution: the source image says 採取, while native/IR says 採用. 雙重機制 appears on the source page across a line break. Accepting the 15% / 15 token mapping does not certify its whole paragraph.</p>'

...
Reviewed packet: [r1/index.html](r1/index.html), with review-record content fingerprint
...
[prepare.py lines 61–71](../prepare.py) reads each fixture to render the report, but fingerprints
...
[prepare.py lines 62–64](../prepare.py) renders only the first table in each synthetic input.
...
every displayed real table says `Grid: resolved`. [prepare.py line 60](../prepare.py) renders
